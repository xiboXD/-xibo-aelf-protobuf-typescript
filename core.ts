...
export class SmartContractRegistration extends Message<SmartContractRegistration> {
   ...
   *
   * @generated from field: aelf.Address contract_address = 7;
   */
   ...
   *
   * @generated from field: bool is_user_contract = 8;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "contract_version", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "contract_address", kind: "message", T: Address },
    { no: 8, name: "is_user_contract", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
